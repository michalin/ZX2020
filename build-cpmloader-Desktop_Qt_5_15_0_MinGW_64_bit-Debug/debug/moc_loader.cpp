...
QT_MOC_LITERAL(1, 7, 12), // "portsChanged"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 8), // "finished"
QT_MOC_LITERAL(4, 30, 9) // "on_RxData"

    },
    "Loader\0portsChanged\0\0finished\0on_RxData"
};
...
void Loader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->portsChanged((*reinterpret_cast< const QStringList(*)>(_a[1]))); break;
        case 1: _t->finished(); break;
        case 2: _t->on_RxData(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Loader::*)(const QStringList );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Loader::portsChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Loader::finished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Loader::portsChanged(const QStringList _t1)
{
